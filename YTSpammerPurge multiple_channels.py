...
def main(channel_to_scan, numVideos_to_scan=1):
    ...
    def primaryInstance(miscData):
                ...
                if config["channel_to_scan"] != "ask":
                    if config["channel_to_scan"] == "mine":
                        ...
                        (
                            ...
                            channelID,
                            channelTitle,
                        ) = validation.validate_channel_id(channel_to_scan)
            ...
            def scan_community_post(
                ...
                for key, value in allCommunityCommentsDict.items():
                    ...
                    try:
                        ...
                        TypeError
                    ):  # Try/Except might not be necessary, might remove later
                        pass
        ...
        if (
            ...
            print(
                "Possible Cause: You're scanning someone else's video with a non-supported filter mode.\n"
            )
            print(
    ...
    for channel in channel_dict:
        ...
        try:
            ...
            if "config" in str(kx):
                ...
                print(
                    f"please post a {F.LIGHTYELLOW_EX}bug report{S.R} on the GitHub issues page, and include the above error info."
                )
            print(f"Short Link: {F.YELLOW}TJoe.io/bug-report{S.R}")
            input("\n Press Enter to Exit...")
            sys.exit()
...
if __name__ == "__main__":
    ...
    all_youtube_channels = {
        ...
        "Comments Section with Brett Cooper": {
            "Channel ID": "UC7bYyWCCCLHDU0ZuNzGNTtg",
            "Num Videos to scan": 3,
        },
        "Nick Freitas": {
            "Channel ID": "UCPFzA28Hw9tYDxXAeidDk6w",
            "Num Videos to scan": 3,
        },
        "Louis Rossmann": {
            "Channel ID": "UCl2mFZoRqjw_ELax4Yisf6w",
            "Num Videos to scan": 3,
        },
        "Hardware Haven": {
            "Channel ID": "UCgdTVe88YVSrOZ9qKumhULQ",
            "Num Videos to scan": 3,
        },
        "Chris Titus Tech": {
            "Channel ID": "UCg6gPGh8HU2U01vaFCAsvmQ",
            "Num Videos to scan": 2,
        },
        "Jayz Two Cents": {
            "Channel ID": "UCkWQ0gDrqOCarmUKmppD7GQ",
            "Num Videos to scan": 2,
        },
        "Prime Video": {
            "Channel ID": "UCQJWtTnAHhEG5w4uN0udnUQ",
            "Num Videos to scan": 3,
        },
        "Tech Linked": {
            "Channel ID": "UCeeFfhMcJa1kjtfZAGskOCA",
            "Num Videos to scan": 2,
        },
        "Stuff Made Here": {
        ...
        "Ben Shapiro": {
            "Channel ID": "UCnQC_G5Xsjhp9fEJKuIcrSw",
            "Num Videos to scan": 5,
        },
        "Linus Tech Tips": {
        ...
        "Legal Eagle": {
            "Channel ID": "UCpa-Zb0ZcQjTCPP1Dx_1M8Q",
            "Num Videos to scan": 2,
        },
        "Doctor Mike": {
            "Channel ID": "UC0QHWhjbe5fGJEPz3sVb6nw",
            "Num Videos to scan": 2,
        },
        "DIY Perks": {
